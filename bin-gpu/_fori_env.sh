...
export img_res=$1
export suffix="_v04_$2_"
export suffixseparator="__"
#export model=model_gia-young-picasso-v03-201216_new
export model=model_gia-young-picasso-v04-2012211928_new
export content=/a/lib/samples/content2012181444
export content=/a/lib/samples/agenticons2012260516
#export content=/a/lib/datasets/paintergansets/paul-cezanne
export savedir=/a/lib/results/it-chkp/v04
export savedir=/a/lib/results/agenticons2012260516
